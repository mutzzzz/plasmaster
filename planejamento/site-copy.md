# Site Copy — Plasmaster
> Versão premium. Todos os fatos preservados do site original. Nenhuma informação inventada.
...
- **Logo:** Plasmaster
- **Menu:** Home · Sobre · Serviços · Contato
...
## 3. Formulário Hero (Sidebar do Banner)

**Título:** Solicite seu Orçamento

**Subtítulo:** Fale com nosso time agora mesmo
...
## 4. Seção — Qualidade e Dedicação

**Headline:**
Precisão em cada detalhe. Qualidade em cada peça.
...
### 4.1 Bloco — Capacidade Técnica

**Título:** Capacidade Técnica
...
**Destaques técnicos:**
- +2.800 horas de capacidade produtiva por mês
- 6 Máquinas Injetoras
- 3 Moinhos

**CTA:** Saiba mais sobre nossa estrutura

---

## 5. Serviços

### 5.1 Terceirização de Injeção de Termoplásticos

**Título:** Terceirização de Injeção de Termoplásticos
...
**Título:** Full Service em Injeção de Termoplásticos
...
## 7. Por Que Escolher a Plasmaster?

**Título:** Por que a Plasmaster?

**Descrição:**
Qualidade, para nós, não é um diferencial — é um compromisso presente em cada etapa do processo. Da seleção criteriosa da matéria-prima ao acabamento final, cada decisão é tomada para garantir que o produto entregue supere as suas expectativas.

**Cards de Diferenciais:**

| Diferencial | Descrição |
|---|---|
| **Qualidade** | Processos rigorosos do início ao fim para garantir peças com precisão e acabamento de excelência. |
| **Suporte** | Uma equipe dedicada, onde cada profissional é peça fundamental para o sucesso do seu projeto. |
| **Tecnologia** | Equipamentos modernos e processos inovadores que transformam ideias em produtos reais. |

**CTA de cada card:** Saiba mais

---

## 8. Contato — Solicite um Orçamento

**Título:** Solicite um orçamento hoje

**Subtítulo:** Nossa equipe está pronta para atender o seu projeto.
...
**E-mail:** adm@plasmaster.ind.br

**Telefone:** (47) 3440-0683

  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Consulte nosso catálogo completo de etiquetas, rótulos e ribbons industriais de alta performance.",
      },
    ],
  }),
});
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <div className="relative w-full h-48 bg-slate-50/60 rounded-2xl overflow-hidden flex items-center justify-center mb-4 border border-border/40 transition-colors group-hover:border-primary/20">
                      {!hasImageFailed ? (
                        ...
                        <div className="flex flex-col items-center gap-2 text-muted-foreground/50 transition-colors group-hover:text-primary/60">
                          ...
                          <span className="text-2xs font-medium uppercase tracking-wider font-mono">
                            Sem Foto
                          </span>
                        </div>
                      )}
                    ...
                    {/* Product Details */}
                    <p className="mt-3 text-sm text-slate-600 leading-relaxed">{product.details}</p>
                  </div>
